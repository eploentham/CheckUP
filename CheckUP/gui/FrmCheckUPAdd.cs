...
namespace CheckUP.gui
{
    public partial class FrmCheckUPAdd : Form
    {
        ...
        int tabCheckList = 19, tabSticker=20;
        int tabCnt = 22;

        int colPERow = 0, colPEId = 1, colPEName = 2, colPESex=3, colPEAge = 4, colPEDepartment=5, colPEPosition=6, colPEVisitHn=7, colPENumber=8, colPEWeight = 9, colPEHeight = 10, colPEBMI = 11, colPEvitalsign = 12, colPEPulse = 13, colPEBloodGroup=14, colPEResult = 15, colPESummary = 16;
        int colPECnt = 17;
        ...
        int colToxiCnt = 30;
        int colVId = 1, colVvisitHn = 2, colVname = 3, colVpatnumber=4;
        int colEId = 1, colEvisitHn = 2, colEname = 3, colEpatnumber = 4;
        int colTId = 1, colTvisitHn = 2, colTname = 3, colTstatusPE = 4, colTstatusXray = 5, colTstatusFBS = 6, colTstatusCBC = 7, colTstatusUA = 8, colTstatusTri = 9;
        int colTstatusCho = 10, colTstatusSgot = 11, colTstatusBUN = 12, colTstatusUric = 13, colTstatusLung = 14, colTstatusAudio = 15, colTstatusEye = 16;
        int colTstatusToxi = 18, colTstatusStoolExam = 17, colTstatusOther1 = 19;
        ...
        private void iniConfig(String cucId)
        {
            ...
            btnFbsSave.Click += BtnPeSave_Click;
            ...
            btnExcelPE.Click += BtnExcelPE_Click;
            btnExcelXray.Click += BtnExcelPE_Click;
            btnExcelFBS.Click += BtnExcelPE_Click;
        ...
        private void GrfView_DoubleClick(object sender, EventArgs e)
        {
            ...
            dtTest = cc.ccpdb.selectByPkSticker(grfView[row, colVId].ToString());
            ...
            dtTest = new DataTable();
            dtTest = cc.ccpdb.selectByPkTest(grfView[row, colVId].ToString());
            ...
            ttt[colS04] = dtTest.Rows[0][cc.ccpdb.ccp.test04].ToString();
            ttt[colS05] = dtTest.Rows[0][cc.ccpdb.ccp.test05].ToString();
            ttt[colS06] = dtTest.Rows[0][cc.ccpdb.ccp.test06].ToString();
            ttt[colS07] = dtTest.Rows[0][cc.ccpdb.ccp.test07].ToString();
            ttt[colS08] = dtTest.Rows[0][cc.ccpdb.ccp.test08].ToString();
            ttt[colS09] = dtTest.Rows[0][cc.ccpdb.ccp.test09].ToString();
            ttt[colS10] = dtTest.Rows[0][cc.ccpdb.ccp.test10].ToString();
            ttt[colS11] = dtTest.Rows[0][cc.ccpdb.ccp.test11].ToString();
            ttt[colS12] = dtTest.Rows[0][cc.ccpdb.ccp.test12].ToString();
            ttt[colS13] = dtTest.Rows[0][cc.ccpdb.ccp.test13].ToString();
            ttt[colS14] = dtTest.Rows[0][cc.ccpdb.ccp.test14].ToString();
            ttt[colS15] = dtTest.Rows[0][cc.ccpdb.ccp.test15].ToString();
            ttt[colS16] = dtTest.Rows[0][cc.ccpdb.ccp.test16].ToString();
            ttt[colS17] = dtTest.Rows[0][cc.ccpdb.ccp.test17].ToString();
        ...
        private void initGrfEmp()
        {
            ...
            grfEmp.AfterFilter += GrfEmp_AfterFilter;
            //grfExpnC.CellButtonClick += new C1.Win.C1FlexGrid.RowColEventHandler(this.grfDept_CellButtonClick);
            //grfExpnC.CellChanged += new C1.Win.C1FlexGrid.RowColEventHandler(this.grfDept_CellChanged);
            //grfJob.CellChanged += GrfExpnD_CellChanged;
        ...
        {
            //throw new NotImplementedException();
            for (int col = grfEmp.Cols.Fixed; col < grfEmp.Cols.Count; ++col)
            {
                var filter = grfEmp.Cols[col].ActiveFilter;
            }
        }
        ...
        private void setGrfTest(String cucid)
        {
            grfTest.DataSource = null;
            ...
            grfTest.Cols[colTname].Editor = txt;
            ...
            for (int i = 1; i <= 20; i++)
            {
                ...
                if (i == 1)
                {
                    ...
                    {
                        grfTest.Cols[colS01].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS01].Visible = false;
                    }
                }
                else if (i == 2)
                {
                    ...
                    {
                        grfTest.Cols[colS02].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS02].Visible = false;
                    }
                }
                else if (i == 3)
                {
                    ...
                    {
                        grfTest.Cols[colS03].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS03].Visible = false;
                    }
                }
                else if (i == 4)
                {
                    ...
                    {
                        grfTest.Cols[colS04].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS04].Visible = false;
                    }
                }
                else if (i == 5)
                {
                    ...
                    {
                        grfTest.Cols[colS05].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS05].Visible = false;
                    }
                }
                else if (i == 6)
                {
                    ...
                    {
                        grfTest.Cols[colS06].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS06].Visible = false;
                    }
                }
                else if (i == 7)
                {
                    ...
                    {
                        grfTest.Cols[colS07].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS07].Visible = false;
                    }
                }
                else if (i == 8)
                {
                    ...
                    {
                        grfTest.Cols[colS08].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS08].Visible = false;
                    }
                }
                else if (i == 9)
                {
                    ...
                    {
                        grfTest.Cols[colS09].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS09].Visible = false;
                    }
                }
                else if (i == 10)
                {
                    ...
                    {
                        grfTest.Cols[colS10].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS10].Visible = false;
                    }
                }
                else if (i == 11)
                {
                    ...
                    {
                        grfTest.Cols[colS11].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS11].Visible = false;
                    }
                }
                else if (i == 12)
                {
                    ...
                    {
                        grfTest.Cols[colS12].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS12].Visible = false;
                    }
                }
                else if (i == 13)
                {
                    ...
                    {
                        grfTest.Cols[colS13].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS13].Visible = false;
                    }
                }
                else if (i == 14)
                {
                    ...
                    {
                        grfTest.Cols[colS14].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS14].Visible = false;
                    }
                }
                else if (i == 15)
                {
                    ...
                    {
                        grfTest.Cols[colS15].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS15].Visible = false;
                    }
                }
                else if (i == 16)
                {
                    ...
                    {
                        grfTest.Cols[colS16].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS16].Visible = false;
                    }
                }
                else if (i == 17)
                {
                    ...
                    {
                        grfTest.Cols[colS17].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS17].Visible = false;
                    }
                }
                else if (i == 17)
                {
                ...
                else if (i == 18)
                {
                    ...
                    {
                        grfTest.Cols[colS18].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS18].Visible = false;
                    }
                }
                else if (i == 19)
                {
                    ...
                    {
                        grfTest.Cols[colS19].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS19].Visible = false;
                    }
                }
                else if (i == 20)
                {
                    ...
                    {
                        grfTest.Cols[colS20].Visible = true;
                    }
                    else
                    {
                        grfTest.Cols[colS20].Visible = false;
                    }
                }
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (i % 2 == 0)
                    row.StyleNew.BackColor = color;
                row[colTId] = dt.Rows[i][cc.ccpdb.ccp.Id].ToString();
                ...
                if (dt.Rows[i][cc.ccpdb.ccp.test01].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS01);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test02].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS02);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test03].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS03);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test04].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS04);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test05].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS05);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test06].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS06);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test07].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS07);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test08].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS08);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test09].ToString().Equals("1"))
                {
                    CellRange cel = grfTest.GetCellRange(i + 1, colS09);
                    cel.StyleNew.BackColor = Color.Green;
                }
                if (dt.Rows[i][cc.ccpdb.ccp.test10].ToString().Equals("1"))
                {
                ...
                //    string aa = "";
                //}
                if (calColVisible() == calCol1(i + 1))
                {
                    CellRange cel1 = grfTest.GetCellRange(i + 1, colTvisitHn, i + 1, colTname);
        ...
        {
            grfSticker = new C1FlexGrid();
            grfSticker.Font = fEdit;
            grfSticker.Dock = System.Windows.Forms.DockStyle.Fill;
            grfSticker.Location = new System.Drawing.Point(0, 0);

            //FilterRow fr = new FilterRow(grfView);

            //grfJob.AfterRowColChange += GrfJob_AfterRowColChange;
            grfSticker.DoubleClick += GrfSticker_DoubleClick;
            //grfExpnC.CellButtonClick += new C1.Win.C1FlexGrid.RowColEventHandler(this.grfDept_CellButtonClick);
            //grfExpnC.CellChanged += new C1.Win.C1FlexGrid.RowColEventHandler(this.grfDept_CellChanged);
            //grfJob.CellChanged += GrfExpnD_CellChanged;
            gbSticker.Controls.Add(grfSticker);
            grfSticker.Clear();
            grfSticker.Rows.Count = 2;
            grfSticker.Cols.Count = 4;
            grfSticker.Cols[colVvisitHn].Width = 80;
            grfSticker.Cols[colVname].Width = 200;

            grfSticker.Cols[colVvisitHn].Caption = "barcode";
            grfSticker.Cols[colVname].Caption = "ชื่อ-นามสกุล";

            grfSticker.Cols[colVId].Visible = false;
            grfSticker.AllowEditing = false;
            grfSticker.AllowSorting = AllowSortingEnum.None;
            //theme1.SetTheme(grfJob, "Office2013Red");
        }
        private void setGrfSticker(String cucid)
        {
            grfSticker.DataSource = null;
            ...
            grfSticker.Cols[colSvisitHn].Editor = txt;
            grfSticker.Cols[colSname].Editor = txt;

            grfSticker.Cols[colSvisitHn].Width = 80;
            grfSticker.Cols[colSname].Width = 200;
            grfSticker.Cols[colS01].Width = 40;
            grfSticker.Cols[colS02].Width = 40;
            grfSticker.Cols[colS03].Width = 40;
            grfSticker.Cols[colS04].Width = 40;
            grfSticker.Cols[colS05].Width = 40;
            grfSticker.Cols[colS06].Width = 40;
            grfSticker.Cols[colS07].Width = 40;
            grfSticker.Cols[colS08].Width = 40;
            grfSticker.Cols[colS09].Width = 40;
            grfSticker.Cols[colS10].Width = 40;
            grfSticker.Cols[colS11].Width = 40;
            grfSticker.Cols[colS12].Width = 40;
            grfSticker.Cols[colS13].Width = 40;
            grfSticker.Cols[colS14].Width = 40;
            grfSticker.Cols[colS15].Width = 40;
            grfSticker.Cols[colS16].Width = 40;
            grfSticker.Cols[colS17].Width = 40;
            grfSticker.Cols[colS18].Width = 40;
            grfSticker.Cols[colS19].Width = 40;
            grfSticker.Cols[colS20].Width = 40;

            grfSticker.Cols[colTvisitHn].Caption = "barcode";
            grfSticker.Cols[colTname].Caption = "ชื่อ-นามสกุล";
            grfSticker.Cols[colS01].Caption = "01";
            grfSticker.Cols[colS02].Caption = "02";
            grfSticker.Cols[colS03].Caption = "03";
            grfSticker.Cols[colS04].Caption = "04";
            grfSticker.Cols[colS05].Caption = "05";
            grfSticker.Cols[colS06].Caption = "06";
            grfSticker.Cols[colS07].Caption = "07";
            grfSticker.Cols[colS08].Caption = "08";
            grfSticker.Cols[colS09].Caption = "09";
            grfSticker.Cols[colS10].Caption = "10";
            grfSticker.Cols[colS11].Caption = "11";
            grfSticker.Cols[colS12].Caption = "12";
            grfSticker.Cols[colS13].Caption = "13";
            grfSticker.Cols[colS14].Caption = "14";
            grfSticker.Cols[colS15].Caption = "15";
            grfSticker.Cols[colS16].Caption = "16";
            grfSticker.Cols[colS17].Caption = "17";
            grfSticker.Cols[colS18].Caption = "18";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                row[colS01] = dt.Rows[i][cc.ccpdb.ccp.sticker01].ToString();
                row[colS02] = dt.Rows[i][cc.ccpdb.ccp.sticker02].ToString();
                row[colS03] = dt.Rows[i][cc.ccpdb.ccp.sticker03].ToString();
                row[colS04] = dt.Rows[i][cc.ccpdb.ccp.sticker04].ToString();
                row[colS05] = dt.Rows[i][cc.ccpdb.ccp.sticker05].ToString();
                row[colS06] = dt.Rows[i][cc.ccpdb.ccp.sticker06].ToString();
                row[colS07] = dt.Rows[i][cc.ccpdb.ccp.sticker07].ToString();
                row[colS08] = dt.Rows[i][cc.ccpdb.ccp.sticker08].ToString();
                row[colS09] = dt.Rows[i][cc.ccpdb.ccp.sticker09].ToString();
                row[colS10] = dt.Rows[i][cc.ccpdb.ccp.sticker10].ToString();
                row[colS11] = dt.Rows[i][cc.ccpdb.ccp.sticker11].ToString();
                row[colS12] = dt.Rows[i][cc.ccpdb.ccp.sticker12].ToString();
                row[colS13] = dt.Rows[i][cc.ccpdb.ccp.sticker13].ToString();
                row[colS14] = dt.Rows[i][cc.ccpdb.ccp.sticker14].ToString();
                row[colS15] = dt.Rows[i][cc.ccpdb.ccp.sticker15].ToString();
                row[colS16] = dt.Rows[i][cc.ccpdb.ccp.sticker16].ToString();
                row[colS17] = dt.Rows[i][cc.ccpdb.ccp.sticker17].ToString();
                row[colS18] = dt.Rows[i][cc.ccpdb.ccp.sticker18].ToString();
                row[colS19] = dt.Rows[i][cc.ccpdb.ccp.sticker19].ToString();
                row[colS20] = dt.Rows[i][cc.ccpdb.ccp.sticker20].ToString();
            ...
            if (txt.Equals("1"))
            {
                if(MessageBox.Show("ต้องการยกเลิก การรับ Test","", MessageBoxButtons.OKCancel)== DialogResult.OK)
                {
                    ...
                    if (grfTest.Row % 2 != 0)
                    {
                        ...
                        CellRange cel = grfTest.GetCellRange(row, col1 + 3);
                        cel.StyleNew.BackColor = color;
                        
                        CellRange cel1 = grfTest.GetCellRange(row, colTvisitHn, row, colTname);
                        cel1.StyleNew.BackColor = color;
                    }
                    else
                    {
                        CellRange cel = grfTest.GetCellRange(row, col1 + 3);
                        cel.StyleNew.BackColor = Color.White;
                        CellRange cel1 = grfTest.GetCellRange(row, colTvisitHn, row, colTname);
        ...
        private void GrfEmp_DoubleClick(object sender, EventArgs e)
        {
            ...
            rrr[colVpatnumber] = grfEmp[row, colEpatnumber].ToString();
        ...
        private void BtnPeSave_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("ต้องการ บันทึกช้อมูล ", "", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.OK)
            {
                ...
                {
                    re = cc.cucdb.updatePE(txtId.Text, txtPECntAbNormal.Text != "" ? txtPECntAbNormal.Text : "0", txtPECntEmp.Text != "" ? txtPECntEmp.Text : "0", txtPECntNormal.Text != "" ? txtPECntNormal.Text : "0", txtPECheckup.Text != "" ? txtPECheckup.Text : "0", txtPETest.Text != "" ? txtPETest.Text : "0");
                    if(int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                }
                else if (sender.Equals(btnXraySave))
                {
                    re = cc.cucdb.updateXray(txtId.Text, txtXrayCntAbNormal.Text != "" ? txtXrayCntAbNormal.Text : "0", txtXrayCntEmp.Text != "" ? txtXrayCntEmp.Text : "0", txtXrayCntNormal.Text != "" ? txtXrayCntNormal.Text : "0", txtXrayCheckup.Text != "" ? txtXrayCheckup.Text : "0", txtXrayTest.Text != "" ? txtXrayTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateFBS(txtId.Text, txtFBSCntAbNormal.Text != "" ? txtFBSCntAbNormal.Text : "0", txtFBSCntEmp.Text != "" ? txtFBSCntEmp.Text : "0", txtFBSNormal.Text != "" ? txtFBSNormal.Text : "0", txtFBSCheckup.Text != "" ? txtFBSCheckup.Text : "0", txtFBSTest.Text != "" ? txtFBSTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateUA(txtId.Text, txtUACntAbNormal.Text != "" ? txtUACntAbNormal.Text : "0", txtUACntEmp.Text != "" ? txtUACntEmp.Text : "0", txtUANormal.Text != "" ? txtUANormal.Text : "0", txtUACheckup.Text != "" ? txtUACheckup.Text : "0", txtUATest.Text != "" ? txtUATest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateTri(txtId.Text, txtTriCntAbNormal.Text != "" ? txtTriCntAbNormal.Text : "0", txtTriCntEmp.Text != "" ? txtTriCntEmp.Text : "0", txtTriNormal.Text != "" ? txtTriNormal.Text : "0", txtTriCheckup.Text != "" ? txtTriCheckup.Text : "0", txtTriTest.Text != "" ? txtTriTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateCho(txtId.Text, txtChoCntAbNormal.Text != "" ? txtChoCntAbNormal.Text : "0", txtChoCntEmp.Text != "" ? txtChoCntEmp.Text : "0", txtChoNormal.Text != "" ? txtChoNormal.Text : "0", txtChoCheckup.Text != "" ? txtChoCheckup.Text : "0", txtChoTest.Text != "" ? txtChoTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateSgot(txtId.Text, txtSgotCntAbNormal.Text != "" ? txtSgotCntAbNormal.Text : "0", txtSgotCntEmp.Text != "" ? txtSgotCntEmp.Text : "0", txtSgotNormal.Text != "" ? txtSgotNormal.Text : "0", txtSgotCheckup.Text != "" ? txtSgotCheckup.Text : "0", txtSgotTest.Text != "" ? txtSgotTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateBun(txtId.Text, txtBunCntAbNormal.Text != "" ? txtBunCntAbNormal.Text : "0", txtBunCntEmp.Text != "" ? txtBunCntEmp.Text : "0", txtBunNormal.Text != "" ? txtBunNormal.Text : "0", txtBunCheckup.Text != "" ? txtBunCheckup.Text : "0", txtBunTest.Text != "" ? txtBunTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateUric(txtId.Text, txtUricCntAbNormal.Text != "" ? txtUricCntAbNormal.Text : "0", txtUricCntEmp.Text != "" ? txtUricCntEmp.Text : "0", txtUricNormal.Text != "" ? txtUricNormal.Text : "0", txtUricCheckup.Text != "" ? txtUricCheckup.Text : "0", txtUricTest.Text != "" ? txtUricTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateOther1(txtId.Text, txtOther1CntAbNormal.Text != "" ? txtOther1CntAbNormal.Text : "0", txtOther1CntEmp.Text != "" ? txtOther1CntEmp.Text:"0", txtOther1Normal.Text != "" ? txtOther1Normal.Text : "0", txtOther1Checkup.Text != "" ? txtOther1Checkup.Text : "0", txtOther1Test.Text != "" ? txtOther1Test.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateLung(txtId.Text, txtLungCntAbNormal.Text != "" ? txtLungCntAbNormal.Text : "0", txtLungCntEmp.Text != "" ? txtLungCntEmp.Text : "0", txtLungNormal.Text != "" ? txtLungNormal.Text : "0", txtLungCheckup.Text != "" ? txtLungCheckup.Text : "0", txtLungTest.Text != "" ? txtLungTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateAudio(txtId.Text, txtAudioCntAbNormal.Text != "" ? txtAudioCntAbNormal.Text : "0", txtAudioCntEmp.Text != "" ? txtAudioCntEmp.Text : "0", txtAudioNormal.Text != "" ? txtAudioNormal.Text : "0", txtAudioCheckup.Text != "" ? txtAudioCheckup.Text : "0", txtAudioTest.Text != "" ? txtAudioTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateEye(txtId.Text, txtEyeCntAbNormal.Text != "" ? txtEyeCntAbNormal.Text : "0", txtEyeTest.Text != "" ? txtEyeTest.Text : "0", txtEyeNormal.Text != "" ? txtEyeNormal.Text : "0", txtEyeCheckup.Text != "" ? txtEyeCheckup.Text : "0", txtEyeTest.Text != "" ? txtEyeTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateToxi(txtId.Text, txtToxiCntAbNormal.Text != "" ? txtToxiCntAbNormal.Text : "0", txtToxiTest.Text != "" ? txtToxiTest.Text: "0", txtToxiNormal.Text != "" ? txtToxiNormal.Text : "0", txtToxiCheckup.Text != "" ? txtToxiCheckup.Text : "0", txtToxiTest.Text != "" ? txtToxiTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
                ...
                {
                    re = cc.cucdb.updateStoolExam(txtId.Text, txtStoolExamCntAbNormal.Text != "" ? txtStoolExamCntAbNormal.Text : "0", txtStoolExamTest.Text != "" ? txtStoolExamTest.Text : "0", txtStoolExamNormal.Text != "" ? txtStoolExamNormal.Text : "0", txtStoolExamCheckup.Text != "" ? txtStoolExamCheckup.Text : "0", txtStoolExamTest.Text != "" ? txtStoolExamTest.Text : "0");
                    if (int.TryParse(re, out chk))
                    {
                        MessageBox.Show("บันทึกข้อมูล เรียบร้อย", "บันทึกช้อมูล");
                    }
        ...
        private void setGrdPE()
        {
            ...
            dgvPE.Columns[colPEPosition].Width = 80;
            dgvPE.Columns[colPEVisitHn].Width = 80;
            dgvPE.Columns[colPENumber].Width = 80;
            ...
            dgvPE.Columns[colPEPosition].HeaderText = "ตำแหน่ง";
            dgvPE.Columns[colPEVisitHn].HeaderText = "visit hn";
            dgvPE.Columns[colPENumber].HeaderText = "รหัสพนักงาน";
        ...
        private void setTextNormal()
        {
            ...
            txtXrayCntNormalPer.Text = chkNormal(txtXrayTest.Text, txtXrayCntNormal.Text);
            txtFBSCntNormalPer.Text = chkNormal(txtFBSTest.Text, txtFBSNormal.Text);
            txtCBCCntNormalPer.Text = chkNormal(txtCBCTest.Text, txtCBCNormal.Text);
            txtUACntNormalPer.Text = chkNormal(txtUATest.Text, txtUANormal.Text);
            txtTriCntNormalPer.Text = chkNormal(txtTriTest.Text, txtTriNormal.Text);
            txtChoCntNormalPer.Text = chkNormal(txtChoTest.Text, txtChoNormal.Text);
            txtSgotCntNormalPer.Text = chkNormal(txtSgotTest.Text, txtSgotNormal.Text);
            txtBunCntNormalPer.Text = chkNormal(txtBunTest.Text, txtBunNormal.Text);
            txtUricCntNormalPer.Text = chkNormal(txtUricTest.Text, txtUricNormal.Text);
            txtOther1CntNormalPer.Text = chkNormal(txtOther1Test.Text, txtOther1Normal.Text);
            txtLungCntNormalPer.Text = chkNormal(txtLungTest.Text, txtLungNormal.Text);
            txtAudioCntNormalPer.Text = chkNormal(txtAudioTest.Text, txtAudioNormal.Text);
            txtEyeCntNormalPer.Text = chkNormal(txtEyeTest.Text, txtEyeNormal.Text);
            txtToxiCntNormalPer.Text = chkNormal(txtToxiTest.Text, txtToxiNormal.Text);
            txtStoolExamCntNormalPer.Text = chkNormal(txtStoolExamTest.Text, txtStoolExamNormal.Text);
        ...
        private void setGrdPE(String cucId)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    dgvPE[colPEPosition, i].Value = dt.Rows[i][cc.ccpdb.ccp.position_name].ToString();
                    dgvPE[colPEVisitHn, i].Value = dt.Rows[i][cc.ccpdb.ccp.visitHn].ToString();
                    dgvPE[colPENumber, i].Value = dt.Rows[i][cc.ccpdb.ccp.patientNumber].ToString();
                    if ((i % 2) != 0)
                    {
        ...
        private String ImportExcel()
        {
            ...
            try
            {
                ...
                for (int i = int.Parse(nmDRow.Value.ToString()); i <= rowCount; i++)
                {
                    try
                    {
                        ...
                        if (xlRange.Cells[i, int.Parse(ei.position_name)].Value2 != null)
                        {
                            ccp.position_name = xlRange.Cells[i, int.Parse(ei.position_name)].Value2.ToString();
                        }
                        else
                        {
                            ccp.position_name = "";
                        }
                        if (xlRange.Cells[i, int.Parse(ei.visit_hn)].Value2 != null)
                        {
                            ccp.visitHn = xlRange.Cells[i, int.Parse(ei.visit_hn)].Value2.ToString();
                        }
                        else
                        {
                            ccp.visitHn = "";
                        ...
                        {
                            ccp.patientNumber = xlRange.Cells[i, int.Parse(ei.patient_number)].Value2.ToString();
                        }
                        else
                        {
                            ccp.patientNumber = "";
            ...
            {
                MessageBox.Show("Error ImportExcel "+ex.InnerException, "message "+ex.Message);
            }
            finally
            {
                //if (xlWorkbook != null)
        ...
        private void FrmCheckUPAdd_Load(object sender, EventArgs e)
        {
            ...
            if (cc.initC.statusonsite.Equals("yes"))
            {
                ...
                theme1.SetTheme(grfEmp, "Office2013Red");
                theme1.SetTheme(grfTest, "Office2013Red");
